...
class LoginAli(object):
    ...
    async def _init(self):
        ...
        await self.page.setUserAgent('Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.106 Safari/537.36')
    ...
    async def main(self, url, username, pwd):
        ...
        if slider:
            ...
            #     print('获取cookie成功')
        print('获取cookie成功')
        self.redis_conn.set(settings.SAVE_KEY, cookie)
        await self.browser.close()

    def run_login(self):
        username = settings.ALI_USER
        password = settings.ALI_PASSWORD
        login_url = settings.ALI_LOGIN_URL
